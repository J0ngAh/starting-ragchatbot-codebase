...
class VectorStore:
    ...
    def get_course_outline(self, course_name: str) -> dict[str, Any] | None:
        """Get course outline with title, link, and all lessons"""
        import json
        ...
        try:
            # Get course from catalog by resolved title
            result = self.course_catalog.get(
                ids=[resolved_title], include=["metadatas"]
            )
