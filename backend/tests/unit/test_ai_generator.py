...
class TestAIGeneratorDirectResponse:
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_generate_response_returns_text_for_direct_answer(self, mock_anthropic_class):
    ...
    def test_generate_response_includes_query_in_messages(self, mock_anthropic_class):
        ...
        mock_client = MagicMock()
        mock_client.messages.create.return_value = build_claude_text_response("Response")
        mock_anthropic_class.return_value = mock_client
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_generate_response_includes_history_when_provided(self, mock_anthropic_class):
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_generate_response_no_history_in_system_when_none(self, mock_anthropic_class):
...
class TestAIGeneratorToolExecution:
    ...
    def test_generate_response_detects_tool_use_stop_reason(self, mock_anthropic_class):
        ...
        tools = [{"name": "search_course_content", "description": "Test", "input_schema": {}}]
    ...
    def test_generate_response_calls_tool_manager_execute(self, mock_anthropic_class):
        ...
        mock_tool_manager = MagicMock()
        mock_tool_manager.execute_tool.return_value = "[ML Course]\nNeural network content"
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_handle_tool_execution_adds_tool_results_message(self, mock_anthropic_class):
    ...
    def test_handle_tool_execution_returns_final_text(self, mock_anthropic_class):
        ...
        final_response = build_claude_text_response("This is the synthesized final answer")
